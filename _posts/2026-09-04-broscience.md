...
- php-deserialization
- command-injection
image: /assets/img/posts/broscience/cover.png
difficulty: Medium
categories:
- Writeups
- Hack The Box
...
![register](/assets/img/posts/broscience/register.png)

I registered a new user and then attempted to log in.

![login](/assets/img/posts/broscience/login.png)
...
![source](/assets/img/posts/broscience/source.png)
...
![register new user](/assets/img/posts/broscience/register_new_user.png)
...
![update username](/assets/img/posts/broscience/update_username.png)
