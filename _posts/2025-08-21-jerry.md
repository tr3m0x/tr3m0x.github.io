...
- windows
- metasploit
image: /assets/img/posts/jerry/cover.png
difficulty: Very Easy
categories:
- Writeups
- Hack The Box
author: tr3m0x
permalink: /blog/writeups/htb/jerry/
...
```bash
tr3m0x@ubuntu:~/htb/windows/Jerry$ sudo nmap -sC -sV -p- -T4 --min-rate 1000 -oN nmap/tcp_scan 10.129.136.9
