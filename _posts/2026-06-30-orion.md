...
- cve-2026-24061
- easy
image: /assets/img/posts/orion/cover.png
difficulty: Easy
categories:
- Writeups
- Hack The Box
author: tr3m0x
permalink: /blog/writeups/htb/orion/
...
```bash
tr3m0x@ubuntu:~/htb/linux/Orion$ sudo nmap -p- --min-rate 1000 -T4 -oN scans/ports.nmap 10.129.244.146
...
Then a deeper scan .
```bash
tr3m0x@ubuntu:~/htb/linux/Orion$ sudo nmap -sC -sV -p 22,80 -oN scans/deepscan.nmap 10.129.244.146
...
```bash
tr3m0x@ubuntu:~/htb/linux/Orion$ echo "10.129.244.146 orion.htb" | sudo tee -a /etc/hosts
```
Now let's visit it in the browser.

![orion.htb](/assets/img/posts/orion/orion.htb.png)
...
```bash
tr3m0x@ubuntu:~/htb/linux/Orion$ ffuf -u http://orion.htb/FUZZ -w $SECLISTS/Discovery/Web-Content/raft-small-directories.txt
...
```bash
tr3m0x@ubuntu:~/htb/linux/Orion$ echo 'admin:$2y$13$e9zuohgFZzGtbQalcn9Mz.5PJbjxobO0GMbXo8NHp3P/B42LUg0lS' > hash.txt

tr3m0x@ubuntu:~/htb/linux/Orion$ john hash --wordlist=$ROCKYOU
...
![CVE-2026-24061](/assets/img/posts/orion/CVE-2026-24061.png)
